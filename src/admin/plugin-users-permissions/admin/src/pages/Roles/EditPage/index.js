...
const EditPage = () => {
  ...
  return (
    <Main>
      ...
      <Formik
        enableReinitialize
        initialValues={{ name: formatMessage(
          { id: 'Role.name.'+ role.name.toLowerCase(), defaultMessage: role.name },
        ), description: formatMessage(
          { id: 'Role.description.'+ role.name.toLowerCase(), defaultMessage: role.description },
        ) }}
